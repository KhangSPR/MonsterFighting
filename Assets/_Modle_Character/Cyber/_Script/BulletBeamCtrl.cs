...
public class BulletBeamCtrl : SkillCtrl
{
    ...
    private void FireLaser()
    {
        ...
        // Nhân chiều dài lên 50 lần
        Vector2 extendedEnd = start + direction * (laserRange * 50f);
        ...
        // Cập nhật BoxCollider2D theo đường laser
