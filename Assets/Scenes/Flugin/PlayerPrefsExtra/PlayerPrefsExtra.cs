...
public static class PlayerPrefsExtra
{
    ...
    #region CardCharacter -----------------------------------------------------------------------------------------

    public static CardCharacter GetCardCharacterSO(string key)
    {
        return Get<CardCharacter>(key, null);
    }

    public static void SetCardCharacterSO(string key, CardCharacter value)
    {
        Set(key, value);
    }
    ...
    #region AreaInfomationSO  -----------------------------------------------------------------------------------------

    public static AreaInfomationSO GetAreaInfomationSO(string key)
    {
        return Get<AreaInfomationSO>(key, null);
    }

    public static void SetAreaInfomationSO(string key, AreaInfomationSO value)
    {
        Set(key, value);
    }
