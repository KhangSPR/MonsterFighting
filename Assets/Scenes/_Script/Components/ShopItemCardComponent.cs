...
{    
    ...
    [SerializeField] GameObject m_ProductCard;
    ...
    public ShopItemCardComponent(GameIconsSO gameIconsData, ShopItemCardSO shopItemData, CardComponent cardComponent)
    {
        m_GameIconsData = gameIconsData;
        m_ShopItemData = shopItemData;
        m_cardComponent = cardComponent;
    }
    public void Initialize(GameIconsSO gameIconsData, ShopItemCardSO shopItemData, CardComponent cardComponent)
    {
        m_GameIconsData = gameIconsData;
        m_ShopItemData = shopItemData;
        m_cardComponent = cardComponent;
    ...
    public void SetGameData(GameObject shopItemElement)
    {
        ...
        m_Background.sprite = m_cardComponent.background;
        m_Frame.sprite = m_cardComponent.frame;
    ...
    bool IsDiscounted(ShopItemCardSO shopItem)
    {
    ...
    public void DisableObjectContainingShopItemCardSO()
    {
    ...
    void BuyAction()
    {
        ...
        ShopItemClicked?.Invoke(this,m_ShopItemData, screenPos);
