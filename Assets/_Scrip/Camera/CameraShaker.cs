...
namespace EZCameraShake
{
    ...
    public class CameraShaker : MonoBehaviour
    {
        ...
        void Awake()
        {
            Instance = this; // Cập nhật Instance ngay trong Awake.
        }

        private void OnEnable()
        {
            // Thêm vào dictionary khi component được enable.
            ...
            {
                Debug.LogError("An item with the name " + gameObject.name + " has already been added to the instance list.");
            }
        }

        private void OnDisable()
        {
            // Loại bỏ khỏi dictionary khi component được disable.
            if (instanceList.ContainsKey(gameObject.name))
            {
